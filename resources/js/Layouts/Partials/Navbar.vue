...
onMounted((notif)=>{
    ...
    notif.getScrollElement().addEventListener('scroll', scrollHandler, { passive: true });
    ...
    function scrollHandler (event) {
        ...
        // console.log(notif.getScrollElement().clientHeight)
    ...
    <header>
        <div class="topbar d-flex align-items-center">
            <nav class="navbar navbar-expand gap-3">
                <div class="mobile-toggle-menu" @click="$emit('mobileToggle')"><i class='bx bx-menu'></i>
                </div>
                    ...
                    <ul class="navbar-nav align-items-center gap-1">
                        ...
                        <li class="nav-item dropdown dropdown-app">
                            ...
                            <div class="dropdown-menu dropdown-menu-end p-0">
                                <div class="app-container p-2 my-2" data-simplebar="true">
                        ...
                        <li class="nav-item dropdown dropdown-large">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="javascript:;">
                                    ...
                                    <div class="header-notifications-list" id="notif">
                        ...
                        <li class="nav-item dropdown dropdown-large">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <div class="header-message-list" data-simplebar="true">
                                    <a class="dropdown-item" href="javascript:;">
